        ...
        <table className="min-w-full table-auto border-collapse">
          <thead>
            <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
              ...
              <th className="py-3 px-4 text-left cursor-pointer" onClick={() => handleSortClick('username')}>
            ...
            {transactions.length > 0 ? (
              transactions.map((transaction) => (
                <tr key={transaction.transactionId} className="border-b border-gray-200 hover:bg-gray-100">
                  <td className="py-3 px-4 text-left whitespace-nowrap">{transaction.transactionId}</td>
                  <td className="py-3 px-4 text-left">{transaction.type}</td>
                  <td className="py-3 px-4 text-left">{transaction.amount.toLocaleString()} {transaction.currency}</td>
                  ...
                  <td className="py-3 px-4 text-left whitespace-nowrap">{transaction.telegramId}</td>
                  <td className="py-3 px-4 text-left">{transaction.username}</td>
