...
const BonusConfigurationPage = () => {
    ...
    const fetchSettings = useCallback(async () => {
        ...
        try {
            ...
            // UPDATED: Destructure and default new fields from the API response
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        // We use keyof BonusSettings as the name matches the interface keys
        const { name, value } = e.target as { name: keyof BonusSettings, value: string };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const hasNegative = Object.values(submissionData).some(val => val < 0);
        ...
        try {
            ...
            setState((s) => ({
                ...
                // UPDATED: Update form fields with saved values
                newSettings: {
            ...
            <div className="w-full max-w-5xl mx-auto flex flex-col h-full">
                ...
                <header className="mb-6 text-center">
                    ...
                    <p className="mt-1 text-gray-400 text-base sm:text-lg">
                        Manage global reward settings for player milestones and activity.
                    </p>
                </header>
                        ...
                        <div className="bg-gray-800 p-6 rounded-2xl shadow-2xl border-t-4 border-teal-500">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <SettingDisplay
                                    ...
                                    icon="🏆"
                                />
                                {/* ADDED: Display for 5 Wins in 24 Hours Bonus */}
                                <SettingDisplay
                                    title="5-Win Daily Streak Bonus"
...
                                    />
                                    ...
                                    {/* ADDED: Input for 5-Win Daily Streak Bonus */}
                                    <InputField
...
// Note: name is now keyof BonusSettings to support all keys
