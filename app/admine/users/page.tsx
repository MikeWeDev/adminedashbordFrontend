...
import { UserTable } from '../../components/UserTable'; // New UserTable component
...
const API_URL = 'http://localhost:5000/api/dashboard'; // Backend API URL
  ...
  return (
    ...
    <main className="bg-gray-100 min-h-screen p-8 ml-64">
      ...
      {/* The cards will display default values (0, N/A) when loading or on error,
          as `summary` is always initialized and falls back to `defaultUserSummary`. */}
      {loadingSummary ? (
